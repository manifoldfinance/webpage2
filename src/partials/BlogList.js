            ...
            <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
              ...
              <div data-aos="fade-left" data-aos-delay="200">
                ...
                <footer className="flex items-center mt-4">
                  <Link to="#">
                    <img className="rounded-full shrink-0 mr-4" src={require('../images/news-author-04.jpg').default} width="40" height="40" alt="Author 04" />
                  </Link>
                  <div>
          ...
          <div className="max-w-sm mx-auto md:max-w-none">
            ...
            <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
              ...
              <article className="flex flex-col h-full" data-aos="fade-up">
                ...
                <footer className="flex items-center mt-4">
                  <Link to="#">
                    <img className="rounded-full shrink-0 mr-4" src={require('../images/news-author-01.jpg').default} width="40" height="40" alt="Author 01" />
                  </Link>
              ...
              <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
                ...
                <footer className="flex items-center mt-4">
                  <Link to="#">
                    <img className="rounded-full shrink-0 mr-4" src={require('../images/news-author-02.jpg').default} width="40" height="40" alt="Author 02" />
                  </Link>
                  <div className="font-medium">
              ...
              <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
                ...
                <footer className="flex items-center mt-4">
                  <Link to="#">
                    <img className="rounded-full shrink-0 mr-4" src={require('../images/news-author-03.jpg').default} width="40" height="40" alt="Author 03" />
                  </Link>
                  <div className="font-medium">
              ...
              <article className="flex flex-col h-full" data-aos="fade-up">
                ...
                <footer className="flex items-center mt-4">
                  <Link to="#">
                    <img className="rounded-full shrink-0 mr-4" src={require('../images/news-author-05.jpg').default} width="40" height="40" alt="Author 05" />
                  </Link>
                  <div className="font-medium">
              ...
              <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
                ...
                <footer className="flex items-center mt-4">
                  <Link to="#">
                    <img className="rounded-full shrink-0 mr-4" src={require('../images/news-author-06.jpg').default} width="40" height="40" alt="Author 06" />
                  </Link>
                  <div className="font-medium">
